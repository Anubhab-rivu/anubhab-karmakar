...
export const metadata = { title: 'Unit 5: Partial Differentiation | AK Notes' };

export default function Unit5Page() {
  return (
    <UnitLayout
      unitNum={5} unitTitle="Partial Differentiation"
      subject="Mathematics-II" subjectSlug="mathematics-2"
      semester="sem-2" degree="diploma"
      degreeBadge="WBSCTE Diploma Engineering"
      prevUnit={{num:4,title:"Ordinary Differential Equations"}} nextUnit={{num:6,title:"Statistics & Probability"}}
    >
      <div style={{textAlign:'center',padding:'60px 20px'}}>
        ...
        <p style={{color:'var(--ink-muted)',maxWidth:400,margin:'0 auto'}}>
          Unit 5: Partial Differentiation notes are being prepared.
