...
export const metadata = { title: 'Unit 1: Wave Motion & SHM | AK Notes' };

export default function Unit1Page() {
  return (
    <UnitLayout
      unitNum={1} unitTitle="Wave Motion & SHM"
      ...
      prevUnit={null} nextUnit={{num:2,title:"Optics"}}
    >
      <div style={{textAlign:'center',padding:'60px 20px'}}>
        ...
        <p style={{color:'var(--ink-muted)',maxWidth:400,margin:'0 auto'}}>
          Unit 1: Wave Motion & SHM notes are being prepared.
