...
export const metadata = { title: 'Unit 3: Angular Measurement | AK Notes' };

export default function Unit3Page() {
  return (
    <UnitLayout
      unitNum={3} unitTitle="Angular Measurement"
      subject="Metrology & Measurement" subjectSlug="metrology"
      semester="sem-4" degree="btech"
      degreeBadge="MAKAUT B.Tech ME"
      prevUnit={{num:2,title:"Linear Measurement"}} nextUnit={{num:4,title:"Surface Finish Measurement"}}
    >
      <div style={{textAlign:'center',padding:'60px 20px'}}>
        ...
        <p style={{color:'var(--ink-muted)',maxWidth:400,margin:'0 auto'}}>
          Unit 3: Angular Measurement notes are being prepared.
