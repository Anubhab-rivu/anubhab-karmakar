...
export const metadata = { title: 'Fluid Mechanics & Machines | AK Notes' };
export default function Page() {
  return (<>
    <header className="page-header crosshatch-bg"><div className="header-inner">
      ...
      <h1>Fluid Mechanics & Machines</h1><p className="subtitle">Code: PC-ME402 | Credits: 4</p>
    </div></header>
    <div style={{maxWidth:800,margin:'0 auto',padding:'48px 24px'}}>
      <div style={{display:'flex',flexDirection:'column',gap:16}}>

            <Link key={1} href="/library/diploma/sem-2/fluid-mechanics/unit-1" style={{display:'flex',alignItems:'center',gap:16,background:'var(--paper-card)',border:'1px solid var(--border)',borderRadius:10,padding:'18px 22px',textDecoration:'none',boxShadow:'var(--shadow)'}}>
            ...
            <Link key={2} href="/library/diploma/sem-2/fluid-mechanics/unit-2" style={{display:'flex',alignItems:'center',gap:16,background:'var(--paper-card)',border:'1px solid var(--border)',borderRadius:10,padding:'18px 22px',textDecoration:'none',boxShadow:'var(--shadow)'}}>
            ...
            <Link key={3} href="/library/diploma/sem-2/fluid-mechanics/unit-3" style={{display:'flex',alignItems:'center',gap:16,background:'var(--paper-card)',border:'1px solid var(--border)',borderRadius:10,padding:'18px 22px',textDecoration:'none',boxShadow:'var(--shadow)'}}>
            ...
            <Link key={4} href="/library/diploma/sem-2/fluid-mechanics/unit-4" style={{display:'flex',alignItems:'center',gap:16,background:'var(--paper-card)',border:'1px solid var(--border)',borderRadius:10,padding:'18px 22px',textDecoration:'none',boxShadow:'var(--shadow)'}}>
            ...
            <Link key={5} href="/library/diploma/sem-2/fluid-mechanics/unit-5" style={{display:'flex',alignItems:'center',gap:16,background:'var(--paper-card)',border:'1px solid var(--border)',borderRadius:10,padding:'18px 22px',textDecoration:'none',boxShadow:'var(--shadow)'}}>
