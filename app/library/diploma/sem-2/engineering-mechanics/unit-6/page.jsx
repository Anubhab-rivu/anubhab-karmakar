...
export const metadata = { title: 'Unit 6: Simple Lifting Machines | AK Notes' };
...
export default function Unit6Page() {
  return (
    <UnitLayout
      ...
      prevUnit={{num:5,title:"Centroid & Centre of Gravity"}} nextUnit={{num:7,title:"Motion in a Plane"}}
    >
      <div style={{textAlign:'center',padding:'60px 20px'}}>
        ...
        <p style={{color:'var(--ink-muted)',maxWidth:400,margin:'0 auto'}}>
          Unit 6: Simple Lifting Machines notes are being prepared.
