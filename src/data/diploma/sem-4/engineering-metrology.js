...
The central skill is reading. You must identify the main scale reading, coinciding vernier or thimble division, least count and zero error. A correct metrology answer is not just a number; it states instrument principle, least count, reading formula, correction and final size with unit. In WBSCTE board exams this unit appears as 2-mark definitions, 5-mark instrument explanations and 10-mark reading numericals. The expected answer structure is labelled diagram, least count derivation, reading steps and practical precautions.
      ...
      workedExamples: [
        ...
        { title: 'Vernier reading with negative zero error', given: ['MSR = 36.5 mm', 'VCD = 12', 'LC = 0.02 mm', 'Zero error = -0.02 mm'], find: 'Corrected reading', solution: [{ step: 1, text: 'Observed reading = 36.5 + 12 x 0.02 = 36.74 mm.' }, { step: 2, text: 'Negative zero error means instrument reads low, so add its magnitude.' }, { step: 3, text: 'True reading = 36.74 + 0.02 = 36.76 mm.' }], answer: 'Corrected vernier reading = 36.76 mm.', examTip: 'Negative zero error is added to the observed reading.' },
        { title: 'Vernier reading without zero error', given: ['MSR = 8 mm', 'VCD = 23', 'LC = 0.02 mm', 'Zero error = 0'], find: 'Final reading', solution: [{ step: 1, text: 'Observed reading = MSR + VCD x LC.' }, { step: 2, text: 'Observed reading = 8 + 23 x 0.02 = 8.46 mm.' }, { step: 3, text: 'Zero error is zero, so true reading equals observed reading.' }], answer: 'Final vernier reading = 8.46 mm.', examTip: 'Always mention zero correction even when it is zero.' },
        { title: 'Vernier least count and reading', given: ['1 MSD = 1 mm', '50 VSD = 49 MSD', 'MSR = 52 mm', 'VCD = 9'], find: 'Least count and reading', solution: [{ step: 1, text: '1 VSD = 49/50 MSD = 0.98 mm.' }, { step: 2, text: 'LC = 1 MSD - 1 VSD = 1 - 0.98 = 0.02 mm.' }, { step: 3, text: 'Reading = 52 + 9 x 0.02 = 52.18 mm.' }], answer: 'LC = 0.02 mm and reading = 52.18 mm.', examTip: 'Least count is MSD minus VSD for direct vernier.' },
        { title: 'Vernier reading with 0.05 mm least count', given: ['MSR = 14.5 mm', 'VCD = 4', 'LC = 0.05 mm', 'Zero error = +0.05 mm'], find: 'True reading', solution: [{ step: 1, text: 'Observed reading = 14.5 + 4 x 0.05 = 14.70 mm.' }, { step: 2, text: 'Positive zero error is subtracted.' }, { step: 3, text: 'True reading = 14.70 - 0.05 = 14.65 mm.' }], answer: 'Corrected vernier reading = 14.65 mm.', examTip: 'Check whether the instrument has 0.02 mm or 0.05 mm least count before multiplying VCD.' },
        ...
        { title: 'Micrometer reading with negative zero error', given: ['LC = 0.01 mm', 'Sleeve reading = 12.0 mm', 'Thimble division = 36', 'Zero error = -0.02 mm'], find: 'Corrected micrometer reading', solution: [{ step: 1, text: 'Observed reading = sleeve + thimble x LC = 12.0 + 36 x 0.01 = 12.36 mm.' }, { step: 2, text: 'Negative zero error is added.' }, { step: 3, text: 'True reading = 12.36 + 0.02 = 12.38 mm.' }], answer: 'Corrected micrometer reading = 12.38 mm.', examTip: 'Negative zero error means the micrometer under-reads.' },
        { title: 'Micrometer half-mm sleeve reading', given: ['LC = 0.01 mm', 'Sleeve reading = 5.5 mm', 'Thimble division = 7', 'Zero error = 0'], find: 'Micrometer reading', solution: [{ step: 1, text: 'The 0.5 mm sleeve mark is visible, so MSR = 5.5 mm.' }, { step: 2, text: 'Thimble contribution = 7 x 0.01 = 0.07 mm.' }, { step: 3, text: 'Reading = 5.5 + 0.07 = 5.57 mm.' }], answer: 'Micrometer reading = 5.57 mm.', examTip: 'Do not drop the visible half-millimetre sleeve mark.' },
        { title: 'Micrometer with 0.005 mm least count', given: ['Pitch = 0.5 mm', 'Thimble divisions = 100', 'Sleeve reading = 18.0 mm', 'Thimble division = 64'], find: 'Least count and reading', solution: [{ step: 1, text: 'LC = pitch/divisions = 0.5/100 = 0.005 mm.' }, { step: 2, text: 'Thimble contribution = 64 x 0.005 = 0.320 mm.' }, { step: 3, text: 'Reading = 18.0 + 0.320 = 18.320 mm.' }], answer: 'Micrometer reading = 18.320 mm.', examTip: 'Use three decimal places when LC is 0.005 mm.' },
        { title: 'Micrometer reading with positive zero error', given: ['LC = 0.01 mm', 'Sleeve reading = 22.5 mm', 'Thimble division = 41', 'Zero error = +0.03 mm'], find: 'Corrected micrometer reading', solution: [{ step: 1, text: 'Observed reading = 22.5 + 41 x 0.01 = 22.91 mm.' }, { step: 2, text: 'Positive zero error is subtracted.' }, { step: 3, text: 'True reading = 22.91 - 0.03 = 22.88 mm.' }], answer: 'Corrected micrometer reading = 22.88 mm.', examTip: 'The correction sign for micrometer is the same logic as vernier instruments.' },
      ...
      interactiveDiagram: { type: 'StressStrain', description: 'Use the closest available visual panel while practising scale resolution, instrument sensitivity and corrected readings.', controls: [{ label: 'Least count', type: 'slider', min: 0.01, max: 0.1, step: 0.01 }], outputs: ['Main scale reading', 'Vernier/thimble contribution', 'Corrected reading'] },
      staticDiagrams: [
...
The basic size is the reference size. Upper and lower limits define the maximum and minimum acceptable sizes. Clearance, interference and transition fits are selected according to function. A sliding bearing needs clearance; a press-fitted gear needs interference; a dowel may use transition fit. In WBSCTE exams this unit appears as 2-mark definitions, 5-mark fit comparisons and 10-mark limit calculation or BIS designation interpretation. The expected answer structure is diagram of tolerance zones, definitions and numerical upper/lower limits.
      ...
      concepts: [
        ...
        { term: 'BIS Fit Designation', definition: 'A BIS fit designation writes basic size, hole tolerance zone and shaft tolerance zone in one compact code such as 50H7/f6.', deepExplanation: `The number gives the basic size in millimetres. The uppercase letter and grade describe the hole tolerance position and tolerance quality; the lowercase letter and grade describe the shaft. Letter position tells where the tolerance zone lies relative to the zero line, while IT grade number tells how wide the tolerance zone is. For 50H7/f6: 50 is basic size, H7 is a standard hole-basis hole with zero lower deviation and IT7 tolerance, and f6 is a shaft zone below the basic size with IT6 tolerance, normally giving a clearance fit. Students often remember only the letters but not the meaning of the grade numbers. In WBSCTE answers, decode the designation in this order: size, hole, shaft, likely fit type, application.`, commonMistake: 'Treating H7/f6 as a material grade instead of a hole/shaft tolerance-zone designation.', formula: 'Basic size + hole zone/shaft zone, e.g. 50H7/f6', unit_: 'mm and IT grade', diagramRef: 'limits-fits-tolerance.svg' },
      ],
      formulas: [
