...
export const metadata = { title: 'Unit 4: Transformers & Machines | AK Notes' };

export default function Unit4Page() {
  return (
    <UnitLayout
      unitNum={4} unitTitle="Transformers & Machines"
      subject="FEEE" subjectSlug="feee"
      semester="sem-2" degree="diploma"
      degreeBadge="WBSCTE Diploma Engineering"
      prevUnit={{num:3,title:"AC Circuits"}} nextUnit={{num:5,title:"Semiconductor Devices"}}
    >
      <div style={{textAlign:'center',padding:'60px 20px'}}>
        ...
        <p style={{color:'var(--ink-muted)',maxWidth:400,margin:'0 auto'}}>
          Unit 4: Transformers & Machines notes are being prepared.
